import mesa
from persona import Citizen
from tqdm import tqdm
from datetime import datetime, timedelta
from traits import generate_names,generate_big5_traits, generate_qualifications,  update_day, clear_cache
import random
import pickle
from prompt import *
...
class World(mesa.Model):
    ...
    '''
    def __init__(self, args, initial_healthy, initial_infected, contact_rate,topic="Default Topic"):
        ...
        self.current_date = datetime(2024, 12, 3)
        self.contact_rate= contact_rate
        self.max_potential_interactions=0
        #Initialize Schedule
        self.schedule = mesa.time.RandomActivation(self)
        self.daily_infected_list = []
        ...
        finance_sentence_susceptible = [
            "I do not believe in this statement, its truth needs further confirmation."
            "I do not believe in this statement, it is definitely false."

        ]

        finance_sentence_infeted = [
            "I believe in this statement, it is true."
        ]
    ...
    def run_model(self, checkpoint_path, offset=0):
        ...
        for i in tqdm(range(self.offset,self.step_count)):
            ...
            self.daily_infected_list.append(self.infected)
            ...
            print(f"Currently Infected:{self.daily_infected_list}")
